...
export const selectHomeRecentTopic = (
  record: TopicEntityRecord | undefined,
...
export const selectHomeTask = (
  record: TaskEntityRecord | undefined,
...
const agentEnrichment = (record: AgentEntityRecord | undefined): BriefItem['agent'] => {
...
export const selectHomeBrief = (
  record: BriefEntityRecord | undefined,
  agentRecord?: AgentEntityRecord,
  taskRecord?: TaskEntityRecord,
): BriefItem | undefined => {
  const active = activeRecord(record);
